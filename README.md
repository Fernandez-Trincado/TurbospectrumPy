...
--
 ...
 1. `NOTE:` The Python script is fully functional and only works for [APOGEE spectra](http://www.sdss.org/dr13/), but can be extended to other cases, if you want to use it in other spectral ranges, please contact me (jfernandez@obs-besancon.fr, jfernandezt87@gmail.com) to discuss the applicability to your case.
