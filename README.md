...
--
  ...
  * I also recommend to use a more complete version for spectral synthesis for [apogee](https://github.com/Fernandez-Trincado/apogee) spetra, developed in Python by Jo Bovy.
