...
atmodel     = raw_input('atmosphere model? (MARCS, KURUCZ) :')
patmodel    = {'MARCS':1,'KURUCZ':2}
...
def file_(inputabu, xelem):
	...
	pinit = patmodel[atmodel]	 

	if ( float(pinit) == 1. ):  # MARCS model ...
	...
	f.write("'MARCS-FILE:' '."+str(ask_model)+".'\n")                                                                                                                                                                                                                                                                                                                                                                                                                                                                      
	...
	f.write("'SPHERICAL:'  '"+str(symetric_init)+"'\n")                                                                                                                                                                                                                                                                                                                                                                                                                                                                           
	f.write("  30\n")                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        
	f.write("  300.00\n")                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    
	f.write("  15    \n")                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    
	f.write("  1.30  \n")                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    
